...
def main():
    ...
    print("\nDecomposing query...")
    subqueries = decompose_query(query, num_subqueries=args.num_subqueries)
    ...
    search_results = search_all_subqueries(subqueries, results_per_query=args.results_per_query)
    ...
    save_search_results(search_results, args.output)
